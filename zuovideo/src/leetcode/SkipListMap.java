...
public class SkipListMap {
    ...
    public static class SkipListMap_1<K extends Comparable<K>, V> {
        private static final double PROBABILITY = 0.5; // < 0.5 继续做，>=0.5 停
        private SkipListNode<K, V> head;
        private int size;
        private int maxLevel;

        public SkipListMap_1() {
    ...
    // for test
    public static void printAll(SkipListMap_1<String, String> obj) {
    ...
    public static void main(String[] args) {
        SkipListMap_1<String, String> test = new SkipListMap_1<>();
        printAll(test);
        System.out.println("======================");
        test.put("A", "10");
        printAll(test);
